...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.addIngredient(new Ingredient("freshly grated black papper", new BigDecimal(2), dashUom));
        ...
        tacosRecipe.addIngredient(new Ingredient("Roughly copped cilantro", new BigDecimal(4), eachUom));
