package com.hyuseinmustafa.spring5recipeproject.bootstrap;

import com.hyuseinmustafa.spring5recipeproject.domain.*;
import com.hyuseinmustafa.spring5recipeproject.repositories.CategoryRepository;
import com.hyuseinmustafa.spring5recipeproject.repositories.RecipeRepository;
import com.hyuseinmustafa.spring5recipeproject.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.getIngredients().add(new Ingredient("freshly grated black papper", new BigDecimal(2), dashUom, guacRecipe));
        ...
        tacosRecipe.getIngredients().add(new Ingredient("Roughly copped cilantro", new BigDecimal(4), eachUom, tacosRecipe));
